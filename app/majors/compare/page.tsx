...
export default function MajorComparePage() {
  ...
  return <div className="page-container">
    ...
    <section className="detail-block" id="dual-lens"><SectionHeading eyebrow="03 / 同题双解" title="同一问题，分别贡献什么，在哪里交接？" description="先看共同目标，再看两种视角的输入、输出和接口。" /><div className="dual-grid">{siteData.dualLensCases.map((item) => <DualLensCard key={item.id} item={item} majorMap={majorMap} />)}</div></section>
