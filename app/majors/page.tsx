...
export default function MajorsPage() {
  return (
    <div className="page-container">
      ...
      <section className="section-quiet section-spaced"><SectionHeading eyebrow="同题双解" title="把两种视角放在一个协作接口里" description="每个案例都明确角色、输入、输出和共同验收结果。" /><div className="dual-grid">{siteData.dualLensCases.map((item) => <DualLensCard key={item.id} item={item} />)}</div></section>
