...
import { getPathways } from '@/lib/content/repository';
...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    ...getPathways().map((pathway) => ({ url: `${base}/pathways/${pathway.slug}`, lastModified: new Date(siteConfig.contentBaseline), changeFrequency: 'monthly' as const, priority: .7 })),
  ];
}
