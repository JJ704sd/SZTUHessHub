...
if (!home.includes('今天先碰一个小问题') || !home.includes('做一次 10 分钟 Starter') || !home.includes('三个任务，只保留影响开始的事实') || !home.includes('机器可达 · 人工与许可待复核') || !home.includes('href="/projects?intent=quick-look"')) failures.push('首页必须 SSR 输出 Release C 三任务、三项目列表与分离的信任状态');
